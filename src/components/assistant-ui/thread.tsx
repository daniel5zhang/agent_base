...
export type ThreadProps = {
  ...
  historyMessages?: ReactNode;
  suppressWelcome?: boolean | undefined;
};
...
}> = ({ historyHeader, historyMessages, isEmpty, suppressWelcome }) => {
  const { Welcome = ThreadWelcome } = useContext(ThreadComponentsContext);
  const showWelcome = isEmpty && !suppressWelcome;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {historyHeader}
          <AuiIf condition={showWelcome ? isNewChatView : () => false}>
            <Welcome />
          </AuiIf>

          <div
            data-slot="aui_message-group"
            className="mb-10 flex flex-col gap-y-7 empty:hidden"
          >
            {historyMessages}
          ...
          <ThreadPrimitive.ViewportFooter
            className={cn(
              "aui-thread-viewport-footer bg-background/95 flex flex-col gap-3 overflow-visible pb-4 backdrop-blur md:pb-6",
              !showWelcome &&
          ...
          >
            ...
            <Composer />
            <AuiIf condition={(s) => !suppressWelcome && isNewChatView(s) && s.composer.isEmpty}>
              <ThreadSuggestions />
            </AuiIf>
          </ThreadPrimitive.ViewportFooter>
        </div>
  ...
  return (
    <div className="aui-composer-action-wrapper relative flex items-center justify-between">
      <div className="flex items-center gap-1.5">
        <TooltipIconButton tooltip="添加插件能力" side="bottom" type="button" variant="ghost" size="icon" className="size-7 rounded-full" aria-label="添加插件能力">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <AuiIf condition={(s) => !s.thread.isRunning}>
          <ComposerPrimitive.Send render={<TooltipIconButton tooltip="发送" side="bottom" type="button" variant="default" size="icon" className="aui-composer-send size-7 rounded-full" aria-label="发送" />}><ArrowUpIcon className="aui-composer-send-icon size-4.5" /></ComposerPrimitive.Send>
        </AuiIf>
        <AuiIf condition={(s) => s.thread.isRunning}>
  ...
  return (
    ...
    >
      <div
        ...
        className="text-foreground px-2 text-[15px] leading-7 wrap-break-word [contain-intrinsic-size:auto_24px] [content-visibility:auto]"
      >
  ...
  return (
    ...
    >
      ...
      <div className="aui-user-message-content-wrapper relative col-start-2 min-w-0">
        <div className="aui-user-message-content peer bg-muted text-foreground rounded-2xl px-4 py-2.5 text-[15px] leading-6 wrap-break-word empty:hidden">
